...
public class G {
    ...
    // Helper class below:
    // -----------------------------------G.V----------------------------------
    public static class V implements Serializable {// vector to track x and y value (like a point)
        public int x, y;
    ...
    // ---------------------------G.VS-----------------------------------------
    public static class VS {// location and size
        public V loc, size;
        ...
        public int xL() {
            return loc.x;
        } // return the left side of the low value of x

        public int xH() {
            return loc.x + size.x;
        } // return the left side of the high value of x

        public int xM() {
            return (loc.x + loc.x + size.x) / 2;
        } // return the left side of the mid value of x

        public int yL() {
            return loc.y;
        } // return the left side of the low value of y

        public int yH() {
            return loc.y + size.y;
        } // return the left side of the high value of y

        public int yM() {
            return (loc.y + loc.y + size.y) / 2;
        } // return the left side of the mid value of y
    }

    // -----------------------------G.LoHi--------------------------------------
    public static class LoHi {// record low and high value (if out of the range, push it, or keep track of
                              // boundaries so far)
        public int lo, hi;
        ...
        } // update when there's a new point

        public int size() {
            return ((hi - lo) == 0) ? 1 : hi - lo;
        } // if hi == low, we return 1 (don't want to return 0)
    ...
    // ----------------------------G.BBox--------------------------------------
    public static class BBox {// Bounding box (smallest & biggest what you drew)
    ...
    // ----------------------------G.PL----------------------------------------
    public static class PL implements Serializable {// Poly lines
        public V[] points;
