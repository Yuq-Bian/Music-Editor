...
public class Stem extends Duration implements Comparable<Stem>{
    ...
    public int yFirstHead(){if(heads.size()==0){return 200;}Head h = firstHead();return h.staff.yLine(h.line);}
    public int yBeamEnd(){
    ...
    public int x(){
        if(heads.size()==0){return 100;}// guard against empty stem
        Head h = firstHead(); 
    ...
    public void deleteStem(){
        if(heads.size() != 0){System.out.println("ERROR - deleting stem that had heads on it");}
